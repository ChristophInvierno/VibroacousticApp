...
def Werte_Ausgangsmaterial_CiE170111_variable_layers(E,G,D,nu,d):
    ...
    #Sum up all layers turned differently than the first(and last) layer D[1] + D[3] +...
...
### ========= Check and return results  =======   
    ...
    # Change entries of E,G and nu
    # New list total thickness d

    # output
    d.append(sum(D))
    del E[:]
    E.extend((E1_eff,E2_eff,E3_eff))
    del G[:]
    G.extend((G1_eff,G2_eff,G3_eff))
    del nu[:]
    nu.extend((nu12_eff,nu21_eff,nu13_eff,nu31_eff,nu23_eff,nu32_eff))
