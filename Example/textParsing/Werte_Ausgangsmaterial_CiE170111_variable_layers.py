...
def Werte_Ausgangsmaterial_CiE170111_variable_layers( E, G, D, NU ):
...
#===============================================================================
    ...
    return [ E1_eff,E2_eff,E3_eff ], \
           [ G1_eff,G2_eff,G3_eff ], \
           [ [ nu12_eff, nu13_eff, nu23_eff ], [ nu21_eff, nu31_eff, nu32_eff ] ], \
           sum(D)
