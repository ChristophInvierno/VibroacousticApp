...
def plotWaveSpeedGraphWithLimits( GraphInstance ):
    ...
    it adjusts the following lines with corresponding labels and colors on the plot:
        WaveVelocity - c_g
        WaveVelocity - c_B_eff
        WaveVelocity - c_L
        WaveVelocity - c_L_thick
        WaveVelocity - c_S
        WaveVelocity - c_S_outofplane_1
        WaveVelocity - c_S_outofplane_2
        WaveVelocity - c_B_shear
        WaveVelocity - c_B
        WaveVelocity - c_B_eff
        WaveVelocity - c_g
        WaveVelocity - c_g_eff
        WaveVelocity - fR_g
        WaveVelocity - fR_B
        WaveVelocity - f_thickmode_shear_y
        WaveVelocity - f_thickmode_shear_x
        WaveVelocity - f_thickmode_long
...
def plotWaveSpeedGraph( GraphInstance ):
        ...
        # ............................ c_B graph ...................................
        # 'Pure bending (thin plate)'
        GraphInstance.GraphData[ COUNTER ].data \
            = dict( XData = GraphInstance.getRange(),
                    YData = GraphInstance.Containers[ "WaveVelocity" ][ "c_B" ] )
...
def plotModalOverlapFactor( GraphInstance ):
    ...
    At the beginning the function cleans the GraphInstance from the previous plot. Then
    it adjusts the following lines with corresponding labels and colors on the plot:
        ModalOverlapFactor - QuasiLongitudinal
        ModalOverlapFactor - Shear
        ModalOverlapFactor - Bending
    :param GraphInstance: an instance of GraphObject class
    :return:
    """
...
def plotMaximumElementSize( GraphInstance ):
    ...
    GraphInstance.defineLine( 0, 'Bending Wave Length', GREEN, 'dotted' )
    ...
    GraphInstance.defineLine( 1, 'Effective Bending Wave Length', GREEN, 'solid' )
    ...
    GraphInstance.defineLine( 2, 'Max. Elem. Size: quadr. shape fct.', GRAY, 'solid' )


def plotEigenfrequenciesPlate( GraphInstance ):
    """
    The function prints and updates the values of the eigen frequencies using the
    Message instance which is a part of an instance of GraphObject class
    :param GraphInstance: an instance of GraphObject class
    :return:
    """
...
def plotScheme( GraphInstance ):
    """
     At the beginning the function cleans the GraphInstance from the previous plot. Then
    it adjusts and plots the scheme of the composite material
    :param GraphInstance: an instance of GraphObject class
    :return:
    """
    print "hello"
